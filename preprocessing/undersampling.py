...
def main():
  ...
  parser.add_argument('-m', '--minority', required=False, help='Label value of the minority class')
  parser.add_argument('-M', '--majority', help='Label value of the majority class')
  ...
  minority_subset = covertype.loc[covertype[args.label] != args.majority]
